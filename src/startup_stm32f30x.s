/**
  ...
  * @version   V0.1.0   (updaded for Atollic TrueSTUDIO)
  * @date      06-April-2012
  * Description STM32F30x devices vector table for Atollic TrueSTUDIO toolchain.
...
g_pfnVectors:
  ...
  .word     EXTI2_TS_IRQHandler               /* EXTI Line2 and Touch Sense */                                             
  ...
  .word     USB_HP_CAN1_TX_IRQHandler         /* USB Device High Priority or CAN1 TX */                                               
  .word     USB_LP_CAN1_RX0_IRQHandler        /* USB Device Low Priority or CAN1 RX0 */                                               
  ...
  .word     0                                 /* Reserved */                                             
  .word     0                                 /* Reserved */                                             
  .word     USB_HP_IRQHandler                 /* USB High Priority remap */                       
  .word     USB_LP_IRQHandler                 /* USB Low Priority remap */                    
  .word     USBWakeUp_RMP_IRQHandler          /* USB Wakeup remap through EXTI */                         
  .word     0                                 /* Reserved */                                       
  .word     0                                 /* Reserved */                                        
  .word     0                                 /* Reserved */                                      
  .word     0                                 /* Reserved */ 
